...
logger=Logs.Log_Gen(f'C:\\NSR_Python_Projects\\Python_Project_Version2\\ETL_Testing_Framework(Config Driven Approach)\\Logs\\Inventory_dim_{dt}.log')


with open(r"C:\NSR_Python_Projects\Python_Project_Version2\ETL_Testing_Framework(Config Driven Approach)\Config\SQL_Queries_config\Inventory_dim.json",'r') as Inventory_data_SQL_fle:
...
dt = datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
output_file_path = f"C:\\NSR_Python_Projects\\Python_Project_Version2\\ETL_Testing_Framework(Config Driven Approach)\\Output_Result\\Inventory_dim_Result_{dt}.xlsx"
